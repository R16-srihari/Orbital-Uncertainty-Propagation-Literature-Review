...
2.  **Initial Moment Characterization:** Compute the raw moments of the initial PDF.
...
2.  **Even Orders:** If $k$ is even, the expectation is equal to the sum of the products of the covariances of all possible unordered pairings of the components:
    $$E[x_{k_1} x_{k_2} \dots x_{k_n}] = \sum_{p \in \Pi} \prod_{\{i,j\} \in p} \sigma_{ij}$$
    *Where:*
...
*(Source:@park-scheeres:10.2514/1.20177)*
:::
