...
To derive the differential equation for the first-order STT $\Phi_{i;a}$, we need the equations @eq-stt-Taylor-map, @eq-stt-eom-Taylor-map and @eq-stt-Taylor-map-time-derivative in first order and follow the steps outlined in @sec-stt-ode.
...
### 2. Time derivative of state deviation Taylor map @eq-stt-Taylor-map {.appendix}
