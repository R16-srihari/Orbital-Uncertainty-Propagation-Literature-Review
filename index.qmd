...
Using similar logic, we can also derive the Taylor expansion for the equations of motion (EOM) for the perturbed state, which is essential for propagating the STTs through time:
