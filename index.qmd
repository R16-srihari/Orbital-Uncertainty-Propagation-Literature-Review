...
### 1. First order Taylor expansion of the state (@eq-stt-taylor-map) {.appendix}
...
### 2. Time derivative of @eq-stt-taylor-map {.appendix}
...
### 4. Substitute @eq-stt-taylor-map into @eq-stt-eom-taylor-map {.appendix}
...
### 5. Balance coefficients {.appendix}
...
### 1. Second order Taylor expansion of the state (@eq-stt-taylor-map) {.appendix}
...
## Step 5. Balance coefficients {.appendix}
