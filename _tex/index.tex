...
\begin{itemize}
\item
  \textbf{Estimating Validity:} Tools like the \textbf{Cauchy--Hadamard
  theorem} are used as a proxy to estimate this radius and check if the
  initial uncertainties are within the valid region.
\item
