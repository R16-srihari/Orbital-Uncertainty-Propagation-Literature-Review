...
follow the steps outlined in Section~\ref{sec-stt-ode}.
...
\subsubsection{\texorpdfstring{2. Time derivative of state deviation
Taylor map
Equation~\ref{eq-stt-Taylor-map}}{2. Time derivative of state deviation Taylor map Equation~}}\label{time-derivative-of-state-deviation-taylor-map-eq-stt-taylor-map}
...
\subsubsection{\texorpdfstring{2. Time derivative of state deviation
Taylor map
Equation~\ref{eq-stt-Taylor-map}}{2. Time derivative of state deviation Taylor map Equation~}}\label{time-derivative-of-state-deviation-taylor-map-eq-stt-taylor-map-1}
