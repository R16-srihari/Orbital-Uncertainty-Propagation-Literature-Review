...
Nonlinear methods can be into three subcategories based on their
fundamental approach to the UP problem.
...
\item
  \textbf{Non-intrusive Polynomial Chaos (PC):} Constructs a functional
  representation of the uncertainty by fitting spectral coefficients to
  transformed samples.
\item
  \textbf{SC Multifidelity (Jones \& Weisman):} A hybrid method included
  in the mind-map that uses stochastic collocation to correct
  low-fidelity samples with a small subset of high-fidelity runs.
\end{itemize}
...
\item
  \textbf{DA-LOADS Multifidelity (Fossà):} The mind-map explicitly
...
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[Initial PDF \& Covariance] {-}{-}\textgreater{} B[Generate Ω Random Samples]}
\NormalTok{    B {-}{-}\textgreater{} C[Propagate Each Sample Independently via RK8/High{-}Fidelity Dynamics]}
\NormalTok{    C {-}{-}\textgreater{} D[Collect Final States]}
\NormalTok{    D {-}{-}\textgreater{} E[Compute Mean \& Covariance]}
\NormalTok{    D {-}{-}\textgreater{} F[Construct Terminal PDF/Histogram]}
\NormalTok{    E {-}{-}\textgreater{} G[Validation Baseline for Other Methods]}
...
\item
  ...
  (PCE)---are used to rapidly evaluate samples.
\item
...
\NormalTok{    B {-}{-}\textgreater{} C[Integrate Nonlinear Dynamics for reference trajectory x*]}
\NormalTok{    C {-}{-}\textgreater{} D[Compute Time{-}Varying Jacobian J*]}
\NormalTok{    D {-}{-}\textgreater{} E[Solve Variational Equations for STM: dΦ/dt = J*Φ]}
...
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[Identify Uncertain Inputs \& Distributions] {-}{-}\textgreater{} B[Perform Isoprobabilistic Transform to Standard Space]}
\NormalTok{    B {-}{-}\textgreater{} C[Select Orthogonal Basis {-} Wiener{-}Askey Scheme]}
\NormalTok{    C {-}{-}\textgreater{} D[Generate Sample Nodes {-} Quadrature/LHS/Sparse Grids]}
\NormalTok{    D {-}{-}\textgreater{} E[Propagate Samples through Black{-}Box Orbital Propagator]}
\NormalTok{    E {-}{-}\textgreater{} F[Estimate Coefficients {-} Projection or Regression]}
\NormalTok{    F {-}{-}\textgreater{} G[Construct PCE Surrogate Model]}
\NormalTok{    G {-}{-}\textgreater{} H[Compute Analytical Moments \& Conjunction Statistics]}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[Define Stochastic Governing Equations] {-}{-}\textgreater{} B[Initialize Uncertain Variables as 1st Degree Polynomials]}
\NormalTok{    B {-}{-}\textgreater{} C[Apply Galerkin Projection to Equations of Motion]}
\NormalTok{    C {-}{-}\textgreater{} D[Reformulate Force Models via Polynomial Algebra]}
\NormalTok{    D {-}{-}\textgreater{} E[Solve Large Coupled System of Deterministic ODEs]}
\NormalTok{    E {-}{-}\textgreater{} F[Reconstruct Terminal PDF from Coefficients]}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    G {-}{-}\textgreater{} H[Check for Non{-}Gaussianity from Nonlinearity Index]}
\NormalTok{    H {-}{-} Yes {-}{-}\textgreater{} I[Reconstruct Higher Moments: Skewness \& Kurtosis]}
\NormalTok{    H {-}{-} No {-}{-}\textgreater{} J[Increase Expansion Order: P] {-}{-}\textgreater{} D}
...
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[Start: Initial State x0 and Covariance P0] {-}{-}\textgreater{} B[Warm Start: Integrate full STT for small step t\textquotesingle{}]}
\NormalTok{    B {-}{-}\textgreater{} C[Compute CGT at t\textquotesingle{}: C = STM\^{}T * STM]}
\NormalTok{    C {-}{-}\textgreater{} D[Eigendecomposition: Find sensitive basis R]}
\NormalTok{    D {-}{-}\textgreater{} E[Integrate State, STM, and DSTT/TDSTT ODEs]}
\NormalTok{    E {-}{-}\textgreater{} F\{Dense Time Grid Output Required?\}}
\NormalTok{    F {-}{-} Yes (TDSTT) {-}{-}\textgreater{} G[Integrate Eigenvector Derivatives B simultaneously]}
\NormalTok{    F {-}{-} No (DSTT) {-}{-}\textgreater{} H[Keep Basis R Fixed]}
\NormalTok{    G {-}{-}\textgreater{} I[Output: Time{-}history of Reduced Taylor Maps]}
\NormalTok{    H {-}{-}\textgreater{} I}
\NormalTok{    I {-}{-}\textgreater{} J[Map Uncertainty: Algebraic calculation of Mean/Covariance]}
\NormalTok{    J {-}{-}\textgreater{} K[End: Nonlinearly Propagated Statistics]}
\end{Highlighting}
\end{Shaded}

\emph{(Ref: Boone and McMahon (2023) )}
...
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[Start: Initial Mean m0 and Covariance P0] {-}{-}\textgreater{} B[Initialize Nominal State and STM]}
\NormalTok{    B {-}{-}\textgreater{} C[Integrate Dynamics and Variational Equations: dx/dt, dSTM/dt]}
\NormalTok{    C {-}{-}\textgreater{} D[Integrate Time{-}Sensitivity Equations: dGamma/dt]}
\NormalTok{    D {-}{-}\textgreater{} E[Obtain Time{-}Phasing Gradient Gamma at tf]}
\NormalTok{    E {-}{-}\textgreater{} F[Construct RSTT Coefficients via Secular Approximation: Eq. 31]}
\NormalTok{    F {-}{-}\textgreater{} G[Map Statistics: Algebraic Summation for Mean and Covariance]}
\NormalTok{    G {-}{-}\textgreater{} H[Result: Propagated Stats at tf]}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{graph TD}
\NormalTok{    A[Start: Initial State x0, Parameters theta, and Event e=0] {-}{-}\textgreater{} B[Augment System: Add Event Derivative Equation]}
\NormalTok{    B {-}{-}\textgreater{} C[Normalize Time: tau = t/T]}
\NormalTok{    C {-}{-}\textgreater{} D[Integrate k{-}th Order Variational Equations to tau=1]}
\NormalTok{    D {-}{-}\textgreater{} E[Obtain Polynomials for State xf and Event Variation eps\_f]}
\NormalTok{    E {-}{-}\textgreater{} F[Apply Map Inversion: Swap eps\_f and Delta T]}
\NormalTok{    F {-}{-}\textgreater{} G[Constraint: Set eps\_f = 0 to solve for Delta T]}
\NormalTok{    G {-}{-}\textgreater{} H[Substitute Delta T into State Polynomial]}
\NormalTok{    H {-}{-}\textgreater{} I[Result: Event Transition Tensors on Manifold]}
\NormalTok{    I {-}{-}\textgreater{} J[Map Statistics: Compute Propagated Moments at Event]}
\end{Highlighting}
\end{Shaded}
